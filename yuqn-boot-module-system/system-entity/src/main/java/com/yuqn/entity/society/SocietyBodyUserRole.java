...
/**
 *
 * @TableName society_body_user_role
 */
@TableName(value ="society_body_user_role")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class SocietyBodyUserRole implements Serializable {
    /**
     *
     */
    ...
    public boolean equals(Object that) {
        ...
        SocietyBodyUserRole other = (SocietyBodyUserRole) that;
